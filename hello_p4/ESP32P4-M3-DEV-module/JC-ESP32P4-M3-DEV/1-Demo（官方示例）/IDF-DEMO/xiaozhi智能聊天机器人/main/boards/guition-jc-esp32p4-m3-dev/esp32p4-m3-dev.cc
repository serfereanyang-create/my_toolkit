...
#define TAG "ESP32P4-M3-Dev"

LV_FONT_DECLARE(font_puhui_20_4);
LV_FONT_DECLARE(font_awesome_20_4);

#ifdef CONFIG_LCD_TYPE_800_1280_10_1_INCH_A
...
class esp32p4m3dev : public WifiBoard {
private:
...
public:
    esp32p4m3dev() : boot_button_(BOOT_BUTTON_GPIO) {  
